                ...
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;">
                        <a href="/store/products">المنتجات</a> <i class="fa-solid fa-angle-left mt-2 ml-2"> </i><a
                            href="">إضافة  منتج</a></h3>
                </div>
            </div>
        </div>
        <form method="post" action="/store/products/store" enctype="multipart/form-data" class="row " style="text-align: right;">
            @csrf
                    ...
                    <div class="card-body fix-withe6" >
                        <form action="#" >
                            ...
                            <div class="form-group">
                                ...
                                <input name="price" type="number" id="text" class="form-control"  style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card" style="border: 0;">
                                        <div class="fix-withe6 card-body" style="text-align: right;">
                                            <div>
                                                <img src="/assets/img/avatar-03.jpg" id="image" alt="" width="179px" height="149px"><br>
