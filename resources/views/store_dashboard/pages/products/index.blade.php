...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row ">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">المنتجات</a></h3>
                </div>
            </div>
        </div>
                ...
                <div style="">
                    ...
                    <div class="bg-white" style="    width: 92%;">
                        ...
                        <div class="table-inline2 d-flex justify-content-between ">
                            <div style="margin:8px 70px 0px 15px; visibility: hidden">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-flex dix-h2" style="margin:16px 22px 0px 10px">
                                    <h5 style="font-size:18px;color: #3CD6D5;">المنتجات</h5>
                            ...
                            <div class="table-responsive" style="width: 100%;">
                                <table id="example" class="table-inline1 table table-striped table-bordered"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">اسم القسم بالعربي</th>
                                        <th scope="col">اسم القسم بالانجليزي</th>
                                                    ...
                                                    <div class="dropdown-menu" style="direction: ltr;">
                                                        <a class="dropdown-item" href="products/delete/{{$item->id}}"
                                                           style=" text-align: right;"> <i class="fa-solid fa-trash-can"
                                                            ...
                                                            حذف </a>
                                                        <a class="dropdown-item" href="products/edit/{{$item->id}}"
...
@section('scripts')
    ...
    <script>
        ...
        function groupDelete() {
            if (ids.length > 0) {
                $.post( "/store/products/groupDelete", {ids: ids}).done(function() {
                    ids.forEach(item => {
                        $("#row-"+item).remove()
                    })
                    $("#0").prop("checked", false)
