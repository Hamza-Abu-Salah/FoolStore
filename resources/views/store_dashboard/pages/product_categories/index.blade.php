...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row ">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">اقسام المنتجات</a></h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-inline2 d-flex justify-content-between ">
                            ...
                            <div class="d-flex">
                                <div style="margin:22px 70px 12px 15px">
                                    ...
                                    <a href="/store/products/categories/create">
...
@section('scripts')
    ...
    <script>
        ...
        function groupDelete() {
            if (ids.length > 0) {
                $.post( "/store/products/categories/groupDelete", {ids: ids}).done(function() {
                    ids.forEach(item => {
                        $("#row-"+item).remove()
                    })
                    $("#0").prop("checked", false)
