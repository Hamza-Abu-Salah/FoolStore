        ...
        <div>
            <div style="text-align: center;font-size: 24px; ">
                <h4 style="font-weight: 700 !important;">
                    ...
                    {{ __('messages.model') }} {{ __('messages.app_name') }}


                </h4>
            </div>
            <div style="text-align: center;font-size: 20px;margin-top: 63px;margin-bottom: 41px; font-weight: 700;">

                <p id="card_login_p">
                    {{ __('messages.model_info') }}
                </p>
                        ...
                        font-size: 24px;   height: 41px;">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                <div class="login-header text-center">
                                    <img src="{{ asset('front/assets/img/Vector.png') }}" alt="" width="45px">
                                </div>
                                <form action="{{route('documentation')}}" method="POST">
                                    @csrf
                                    <div class="form-group " style="font-weight: 700 ">
                                        <label class="focus-label"> {{__('messages.phone_number')}}  <span class="text-danger">*</span> </label>
                                        <input type="number" name="phone" class="form-control">
                                    </div>
                                    <div class="form-group row" style="font-weight: 700 ">
                                        <label class="col-lg-4 col-form-label">{{__('messages.country')}}  <span
                                    ...
                                    <button class="btn btn-primary btn-block btn-lg login-btn"
                                        style="background: #969FA4;" type="submit">{{__('messages.send')}} </button>
