            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;">
                        <a href="/categories">الأقسام</a> <i class="fa-solid fa-angle-left mt-2 ml-2"> </i>إضافة  قسم</h3>
                </div>
            </div>
        </div>
        <form method="post" action="/categories/update/{{$item->id}}" enctype="multipart/form-data" class="row " style="text-align: right;">
            @csrf
