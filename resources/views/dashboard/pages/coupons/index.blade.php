...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">كوبونات الخصم</a></h3>
                </div>
                <div class="content1 content container-fluid " style="padding-bottom: 40px; background: #E5E5E5;">
                    ...
                    <div class="buttons">
                            ...
                            <div class="btn1 d-flex justify-content-between">
                                ...
                                <div class="btn2 d-flex">
                                    ...
                                    <div class="h9 d-flex " style="margin:16px 22px 15px 10px">
                                        <h5 style="font-size:18px;color: #3CD6D5;">كوبونات الخصم</h5>
                            ...
                            <div class="fix-buttonss1 table-responsive" style=" width: 100%;">
                                ...
                                <table id="example"
                                    ...
                                    <tr style="text-align: center; ">
                                        ...
                                        <th scope="col" style="text-align: right;">الكود</th>
                                        <th scope="col" style="text-align: right;">النوع</th>
                                        <th scope="col" style="text-align: right;">قيمة الخصم</th>
                                        <th scope="col" style="text-align: right; ">عدد مرات الاستخدام</th>
                                    ...
                                    <tr style="text-align: center;" id="row-{{$item->id}}">
                                        <td><input onchange="checkbox({{$item->id}})" type="checkbox" id="{{$item->id}}"></td>
                                            ...
                                            <th>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="/coupons/delete/{{$item->id}}" class="dropdown-item"
                                                        ...
                                                        <button type="button" class=" btn  " data-toggle="modal"
                                                                data-target="#edit-{{$loop->iteration}}" style="border: none;">
                                        ...
                                        <div class="modal fade" id="edit-{{$loop->iteration}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            ...
                                            <form method="post" id="edit-form-{{$loop->iteration}}" action="/coupons/update/{{$item->id}}" class="modal-dialog">
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header" style="direction: rtl;">
                                                        <h5 class="modal-title " id="staticBackdropLabel">تعديل كوبون</h5>
                                                        <button type="button"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card-body fix-withe6" style="text-align: -webkit-right;">
                                                                <div class="form-group">
                                                                    <label style="text-align:right;font-size: 18px; color: #C4C4C4"> كود
                                                                        الخصم</label>
                                                                    <input name="code" value="{{$item?->code}}" type="text" id="text" class="form-control"
                                                                           style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                                </div>
                                                            <div class="form-group">
                                                                <label style="text-align:right;font-size: 18px; color: #C4C4C4">
                                                                    نوع الخصم</label>
                                                                <select name="type" id="text" class="form-control"
                                                                        style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                                    <option {{$item?->type == '1'? 'selected' : ''}} value="1">ثابت</option>
                                                                    <option {{$item?->type == '1'? '' : 'selected'}} value="2">نسبة مئوية</option>
                                                                </select>
                                                            </div>
                                                                <div class="form-group">
                                                                    <label style="text-align:right;font-size: 18px; color: #C4C4C4">قيمة
                                                                        الخصم </label>
                                                                    <input name="amount" value="{{$item?->amount}}" type="text" id="name" class="form-control"
                                                                           style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                                </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form method="post" action="/coupons/store" class="modal-dialog">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header" style="direction: rtl;">
                                        <h5 class="modal-title " id="staticBackdropLabel">إضافة كوبون</h5>
                                        <button type="button"
                                                style="margin-left: 0; border: none; outline: none; background: none"
                                                class="btn-close" data-dismiss="modal" aria-label="Close">
                                            <i class="fas fa-times"></i>
                                        ...
                                        <div class="card-body fix-withe6" style="text-align: -webkit-right;">
                                            <form>
                                                <div class="form-group">
                                                    <label style="text-align:right;font-size: 18px; color: #C4C4C4"> كود
                                                        الخصم</label>
                                                    <input name="code" type="text" id="text" class="form-control"
                                                           style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                </div>
                                                <div class="form-group">
                                                    <label style="text-align:right;font-size: 18px; color: #C4C4C4">
                                                ...
                                                <div class="form-group">
                                                    <label style="text-align:right;font-size: 18px; color: #C4C4C4">قيمة
                                                        الخصم </label>
                                                    <input name="amount" type="number" id="name" class="form-control"
                                                           style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                </div>
                                            </form>
                                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function groupDelete() {
            if (ids.length > 0) {
                $.post( "/coupons/groupDelete", {ids: ids}).done(function() {
                    ids.forEach(item => {
                        $("#row-"+item).remove()
                    })
                    $("#0").prop("checked", false)
