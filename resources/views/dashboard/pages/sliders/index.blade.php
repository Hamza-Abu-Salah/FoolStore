...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row ">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">سلايدر</a></h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-inline2 d-flex justify-content-between ">
                            ...
                            <div class="d-flex">
                                <div style="margin:22px 70px 12px 15px">
                                    ...
                                    <a href="/sliders/create" type="button" class="btn text-white btn-green"
                                       style="border: none;">
                                        اضافة جديد<i class="fa-solid fa-trash-can"></i>
                                    </a>
                                </div>

                                <div class="d-flex dix-h2" style="margin:16px 22px 0px 10px">
                                    <h5 style="font-size:18px;color: #3CD6D5;">سلايدر</h5>
                                ...
                                <table id="example" class="table-inline1 table table-striped table-bordered"
                                    ...
                                    @forelse($items as $item)
                                        <tr style="text-align: center;" id="row-{{$item->id}}">
                                            ...
                                            <td>
                                                <img src="{{ asset($item->image?? "/assets/img/avatar-03.jpg") }}"
                                            ...
                                            <th>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" style="direction: ltr;">
                                                        <a class="dropdown-item" href="/sliders/delete/{{$item->id}}"
                                                           style=" text-align: right;"> <i class="fa-solid fa-trash-can"
                                                                                           style="margin-right: 77px;"></i>
                                                            حذف </a>
                                                        <a class="dropdown-item" href="/sliders/edit/{{$item->id}}"
...
@section('scripts')
    <script>
        ...
        function groupDelete() {
            if (ids.length > 0) {
                $.post( "/sliders/groupDelete", {ids: ids}).done(function() {
                    ids.forEach(item => {
                        $("#row-"+item).remove()
                    })
                    $("#0").prop("checked", false)
