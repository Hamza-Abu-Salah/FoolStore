    ...
    <div class="page-wrapper" style="background:#E5E5E5 ; height: 150%;">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;">
                        <a href="/leaders">الكابتن</a> <i class="fa-solid fa-angle-left mt-2 ml-2"> </i><a href="">إضافة
                            كابتن</a></h3>
                </div>
            </div>
        </div>
        <div class="row " style="text-align: right;">
            <div class="content1 col-sm-12">
                <form action="/leaders/store" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title" style="color:#3CD6D5">إضافة كابتن</h5></div>
                        <div class="card-body">
                            ...
                            <div class="row g-2 d-flex" style="margin-bottom: 13px;width: 100%;">
                                <div class="col-md">
                                    <div class="form-floating">
                                        ...
                                        <input name="latitude" type="number" class="form-control" id="floatingInputGrid"
                                ...
                                <div class="col-md">
                                    <div class="form-floating">
                                        ...
                                        <input name="longitude" type="number" class="form-control" id="floatingInputGrid"
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" id="name" class="form-control" placeholder="اسم الكابتن "
                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                            <div class="form-group">
                                <label style="text-align:right;font-size: 12px; color: #C4C4C4">رقم الجوال </label>
                                <input name="phone" type="text" id="number" class="form-control" placeholder="رقم الجوال "
                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                            <div class="form-group">
