            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;">
                        <a href="/cards">الكروت</a> <i class="fa-solid fa-angle-left mt-2 ml-2"> </i><a href="">إضافة كارت شحن</a></h3>
                </div>
            </div>
        </div>
        <form method="post" action="/cards/update/{{$item->id}}" class="row " style="text-align: right;">
            @csrf
                    ...
                    <div class="card-body fix-withe6" >
                        <form action="#" >
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $item?->number }}" name="number" type="text" id="text" class="form-control"  style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                            <div class="form-group">
                                <label style="text-align:right;font-size: 12px; color: #C4C4C4">قيمة الكارت </label>
                                <input value="{{ $item?->value }}" name="value" type="number" id="name" class="form-control"  style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
