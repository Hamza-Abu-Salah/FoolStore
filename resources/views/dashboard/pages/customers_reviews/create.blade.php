    ...
    <div class="page-wrapper" style="background:#E5E5E5 ; height: 150%;">
        ...
        <div class="row " style="text-align: right;">
            <div class=" content1 col-sm-12">
                <form action="/customers/reviews/store" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        @if($errors->all())
                        ...
                        <div class="fix-withe6 card-body">
                            ...
                            <div class="form-group">
                                <label style="text-align:right;font-size: 16px; color: #C4C4C4">المحتوى
                                    بالعربي </label>
                                <input name="content_ar" type="text" id="number" class="form-control"
                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                            <div class="form-group">
                                <label style="text-align:right;font-size: 16px; color: #C4C4C4">المحتوى
                                    بالانجليزي </label>
                                <input name="content_en" type="text" id="number" class="form-control"
                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="card" style="border: 0;">
                                        <div class="fix-withe6 card-body" style="border: 0;">
                                            <div>
                                                <img src="/assets/img/avatar-03.jpg" alt="" width="179px"
