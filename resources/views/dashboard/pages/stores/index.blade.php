                            ...
                            <div class="table-responsive" style="width: 100%;">
                                <table id="example" class="table-inline1 table table-striped table-bordered"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">عدد الأفراد المتاحة</th>
                                    ...
                                    @forelse($items as $item)
                                        <tr style="text-align: center;" id="row-{{$item->id}}">
                                            ...
                                            <td>
                                                @if($item->status)
                                                    <a href="/stores/toggle_status/{{$item->id}}" type="button" class="btn text-white"
                                                            style="font-size: 12px;background: #17a700"> مقبول <i
...
{{--                                                        <a class="dropdown-item" href="order-store1.html"--}}
{{--                                                           style=" text-align: right;">عرض <i class="fa-solid fa-eye "--}}
{{--                                                                                              style="margin-right: 71px;"></i></a>--}}
                                                        <a class="dropdown-item" href="/stores/edit/{{$item->id}}"
                                                           style=" text-align: right;">تعديل <i class="fa-solid fa-pen "
                                                                                                style="margin-right: 71px;"></i></a>
{{--                                                        <a class="dropdown-item" href="/stores/{{$item->id}}/products"--}}
{{--                                                           style=" text-align: right;">منتجات <i--}}
