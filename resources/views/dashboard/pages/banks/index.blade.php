...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">البنوك</a></h3>
                </div>
                <div class="content1 content container-fluid " style="padding-bottom: 40px; background: #E5E5E5;">
                    ...
                    <div class="buttons">
                            ...
                            <div class="btn1 d-flex justify-content-between">
                                ...
                                <div class="btn2 d-flex">
                                    ...
                                    <div class="h9 d-flex " style="margin:16px 22px 15px 10px">
                                        <h5 style="font-size:18px;color: #3CD6D5;">البنوك</h5>
                                ...
                                <table id="example"
                                    ...
                                    @forelse($items as $item)
                                        <tr style="text-align: center;" id="row-{{$item->id}}">
                                            ...
                                            <th>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="/banks/delete/{{$item->id}}" class="dropdown-item"
                                        ...
                                        <div class="modal fade" id="edit-{{$loop->iteration}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            ...
                                            <form method="post" id="edit-form-{{$loop->iteration}}"
                                                  action="/banks/update/{{$item->id}}" class="modal-dialog">
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header" style="direction: rtl;">
                                                        <h5 class="modal-title " id="staticBackdropLabel">تعديل بنك</h5>
                                                        <button type="button"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card-body fix-withe6"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="bank_number" value="{{$item?->bank_number}}" type="text"
                                                                       id="name" class="form-control"
                                                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                                            </div>
                                                        </div>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form method="post" action="/banks/store" class="modal-dialog">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header" style="direction: rtl;">
                                        <h5 class="modal-title " id="staticBackdropLabel">إضافة بنك</h5>
                                        <button type="button"
                                                style="margin-left: 0; border: none; outline: none; background: none"
                                    ...
                                    <div class="modal-body">
                                        <div class="card-body fix-withe6" style="text-align: -webkit-right;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="bank_number" type="text" id="bank_number" class="form-control"
                                                       style="text-align: right; border: 0; border-bottom: 1px solid #C4C4C4;">
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function groupDelete() {
            if (ids.length > 0) {
                $.post( "/banks/groupDelete", {ids: ids}).done(function() {
                    ids.forEach(item => {
                        $("#row-"+item).remove()
                    })
                    $("#0").prop("checked", false)
