                        ...
                        <div class="table-inline2 d-flex justify-content-between ">
                            ...
                            <div class="d-flex">
                                <div style="margin:22px 70px 12px 15px">
                                    ...
                                    <button type="button" class="btn-red btn btn-primary  " style="border: none;">
                                ...
                                <table id="example" class="table-inline1 table table-striped table-bordered"
                                    ...
                                    @forelse($items as $item)
                                        <tr style="text-align: center;">
                                            <td class="row-1">{{ $loop->iteration }}</td>
                                            <td class="row-2">{{ $item->name?? 'غير متوفر' }}</td>
                                            <td class="row-3">
                                                <img src="{{ asset($item->avatar?? "/assets/img/avatar-03.jpg") }}"
