...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row ">
                <div class="col-sm-12">
                    <h3 class="page-title" style="padding-right: 32px;"><a href="">منتجات مقبولة</a></h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-inline2 d-flex justify-content-between ">
                            ...
                            <div class="d-flex">
                                <div class="d-flex dix-h2" style="margin:16px 22px 0px 10px">
                                    <h5 style="font-size:18px;color: #3CD6D5;">منتجات مقبولة</h5>
